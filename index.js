   ...
   */
    ...
    return {
        ...
        */
        ...
        /**
        * Get the fiat deposit history
        * @param {function} callback - the callback function
        * @param {object} params - additional params
        * @return {promise or undefined} - omitting the callback returns a promise
        */
        fiatDepositHistory: function ( callback, params = {} ) {
            if ( typeof params === 'string' ) params = { asset: params };
            if ( !callback ) {
                return new Promise( ( resolve, reject ) => {
                    callback = ( error, response ) => {
                    ...
                    signedRequest( sapi + 'v1/fiat/payments', params, callback );
                } )
            } else {
                signedRequest( sapi + 'v1/fiat/payments', params, callback );
            }
        ...
        /**
        * Get the stacking history
        * @param {function} callback - the callback function
        * @param {object} params - additional params
        * @return {promise or undefined} - omitting the callback returns a promise
        */
        stackingHistory: function ( callback, params = {} ) {
            if ( typeof params === 'string' ) params = { asset: params };
            if ( !callback ) {
                return new Promise( ( resolve, reject ) => {
                    callback = ( error, response ) => {
                    ...
                    signedRequest( sapi + 'v1/staking/stakingRecord', params, callback );
                } )
            } else {
                signedRequest( sapi + 'v1/staking/stakingRecord', params, callback );
            }
        ...
        * @return {promise or undefined} - omitting the callback returns a promise
        */
        stackingPosition: function ( callback, params = {} ) {
            if ( typeof params === 'string' ) params = { asset: params };
            if ( !callback ) {
                return new Promise( ( resolve, reject ) => {
                    callback = ( error, response ) => {
                    ...
                    signedRequest( sapi + 'v1/staking/position', params, callback );
                } )
            } else {
                signedRequest( sapi + 'v1/staking/position', params, callback );
            }
        ...
        /**
        * Get the flexible stacking position
        * @param {function} callback - the callback function
        * @param {object} params - additional params
        * @return {promise or undefined} - omitting the callback returns a promise
        */
        flexibleStackingPosition: function ( callback, params = {} ) {
            if ( typeof params === 'string' ) params = { asset: params };
            if ( !callback ) {
                return new Promise( ( resolve, reject ) => {
                    callback = ( error, response ) => {
                    ...
                    signedRequest( sapi + 'v1/lending/daily/token/position', params, callback );
                } )
            } else {
                signedRequest( sapi + 'v1/lending/daily/token/position', params, callback );
            }
        ...
        /**
        * Get the NFT transaction history
        * @param {function} callback - the callback function
        * @param {object} params - additional params
        * @return {promise or undefined} - omitting the callback returns a promise
        */
        nftTransactionHistory: function ( callback, params = {} ) {
            if ( typeof params === 'string' ) params = { asset: params };
            if ( !callback ) {
                return new Promise( ( resolve, reject ) => {
                    callback = ( error, response ) => {
                    ...
                    signedRequest( sapi + 'v1/nft/history/transactions', params, callback );
                } )
            } else {
                signedRequest( sapi + 'v1/nft/history/transactions', params, callback );
            }
